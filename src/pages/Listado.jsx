...
function Listado() {
    ...
    const getTareas = async () => {
        try {
            const response = await axios.get('https://dev4humans.com.mx/api/Clases/tareas?usuario=Daniel', { headers });
    ...
    useEffect(() => {
        console.log("Entro a useEffect aqui debo cargar mis tareas");
        getTareas();

    }, []);

    //formatear fecha con data-fn
    if (loading){
        return (<Loading />)
    }
